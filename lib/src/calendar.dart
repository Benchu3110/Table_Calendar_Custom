...
typedef HeaderCallBack = void Function(DateTime date);
...
class TableCalendar extends StatefulWidget {
  ...
  HeaderCallBack previousMonthCallback;
  HeaderCallBack nextMonthCallback;
  ...
  @override
  _TableCalendarState createState() => _TableCalendarState(previousMonthCallback: previousMonthCallback,nextMonthCallback: nextMonthCallback);
}
...
class _TableCalendarState extends State<TableCalendar>
  ...
  HeaderCallBack previousMonthCallback;
  HeaderCallBack nextMonthCallback;
  _TableCalendarState({this.previousMonthCallback,this.nextMonthCallback});
  @override
  void initState() {
    super.initState();
  ...
  void _selectPrevious() {
    previousMonthCallback(widget.calendarController._focusedDay);
    setState(() {
  ...
  void _selectNext() {
    nextMonthCallback(widget.calendarController._focusedDay);
    setState(() {
